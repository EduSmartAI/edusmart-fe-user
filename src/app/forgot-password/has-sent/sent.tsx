        ...
        >
          ...
          <div className="px-6 sm:px-10 py-8 sm:py-10 text-center">
            ...
            <Paragraph className="!mt-1 !text-slate-600 dark:!text-slate-300">
              ...
              . Email có thể mất 1-2 phút, đừng quên kiểm tra cả mục Spam/Quảng
              cáo.
            </Paragraph>
            ...
            <div className="mx-auto max-w-xl text-left sm:text-center">
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
                <li>
                  • Tìm với từ khóa <b>{brand}</b> hoặc “reset password” trong hộp
                  thư.
                </li>
                <li>
                  • Kiểm tra <i>Spam / Quảng cáo</i> nếu chưa thấy email sau vài phút.
                </li>
              ...
              <div className="mt-4 flex flex-col items-center gap-2 text-sm">
                <span className="text-slate-600 dark:text-slate-300">
                  ...
                  <Link
                    ...
                    className="text-teal-600 dark:text-teal-300 font-semibold"
                  >
                    Nhập lại email
                  </Link>
                </span>
                {onResend && (
                  <Button
                    ...
                    disabled={left > 0}
                    icon={<FiMail />}
                    className="mt-1 rounded-full px-6 py-0 h-9"
                  >
                    {left > 0
                      ? `Gửi lại email sau ${left}s`
              ...
              <div className="mt-3 inline-flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                <FiShield />{" "}
                <span>
                  Liên kết đặt lại chỉ có hiệu lực trong thời gian ngắn để đảm
                  bảo an toàn.
                </span>
              </div>
            </div>
            ...
            <div className="mt-8 flex items-center justify-center gap-2 text-slate-400">
              ...
              <span className="text-sm">{brand} · bảo vệ tài khoản của bạn</span>
            </div>
          </div>
        </div>
      </ZoomIn>
